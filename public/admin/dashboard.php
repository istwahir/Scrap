        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm p-6 border border-gray-100 dark:border-slate-700">
                    ...
                    <div class="space-y-3">
                        <button onclick="location.href='/Scrap/public/admin/collectors.php'"
                        ...
                        <button onclick="location.href='/Scrap/public/admin/dropoffs.php'"
                        ...
                        <button onclick="location.href='/Scrap/public/admin/reports.php'"
                        ...
                        <button onclick="location.href='/Scrap/public/admin/rewards.php'"
